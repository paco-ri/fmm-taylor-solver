program vacuum_example
    ...
    igeomtype = 6 ! set to 4 for toroidal geometry
    norder = 8
    ...
    ! setting up GMRES
    eps = 0.51d-4
    eps_gmres = 1d-8 ! changing this seems to do little 
    flux = 0.3d0
    numit = 200
    niter1 = 0
    niter2 = 0
    ...
    ! this is NOT the correct way to compute relative error
    ! take ratio of maxes, not max of ratios
